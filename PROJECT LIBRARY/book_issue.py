...
# Form implementation generated from reading ui file 'book_issue.ui'
#
...
"background-color: rgb(255, 35, 39);")
        ...
        self.issue_book = QtWidgets.QPushButton(self.centralwidget,clicked=lambda:self.issueb())
        self.issue_book.setGeometry(QtCore.QRect(340, 420, 91, 51))
        self.issue_book.setStyleSheet("background-color: rgb(212, 255, 0);\n"
"color:rgb(0, 0, 0);\n"
"font-weight:bold;\n"
"font-size:15px;")
        self.issue_book.setObjectName("issue_book")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "                BOOK ISSUE"))
        self.issue_book.setText(_translate("MainWindow", "ISSUE"))
