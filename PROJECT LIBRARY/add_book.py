...
class add_book(object):
    def addbook(self):
        ...
        no_of_books = self.lineEdit_4.text()
...
"background-color: rgb(255, 35, 39);")
        ...
        self.add_book = QtWidgets.QPushButton(self.centralwidget,clicked=lambda:self.addbook())
        self.add_book.setGeometry(QtCore.QRect(340, 420, 91, 51))
        self.add_book.setStyleSheet("background-color: rgb(212, 255, 0);\n"
"color:rgb(0, 0, 0);\n"
"font-weight:bold;\n"
"font-size:15px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "NO. OF BOOKS    :"))
        self.label_6.setText(_translate("MainWindow", "                ADD BOOK"))
        self.add_book.setText(_translate("MainWindow", "ADD"))
